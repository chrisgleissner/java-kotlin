...
| [String templates](https://kotlinlang.org/docs/strings.html#string-templates) | string     | Reference variables directly from strings.                                                                                                                                                                                               | `"foo=%s, bar=%s".formatted(foo, bar)`                                                                                                 | Java is harder to read, especially when using many variables.                                                                                            |
