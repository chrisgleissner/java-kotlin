...
| [Exceptions](https://kotlinlang.org/docs/exceptions.html)                     | exc        | Kotlin does not have checked exceptions as they have fallen [out of favour](https://kotlinlang.org/docs/exceptions.html#checked-exceptions) with developers over the years as they increase code clutter without many tangible benefits. |                                           | `try / catch` exception and rethrow non-checked or Lombok's `SneakyThrows` (currently fails on Java 22) | Java is more verbose, requiring workarounds that introduce code clutter.                                      |
